...
func artifactory(file: String, repo: String, repoPath: String, endpoint: String, username: String, password: String, properties: [String: Any] = [:], sslPemFile: String? = nil, sslVerify: Bool = true, proxyUsername: String? = nil, proxyPassword: String? = nil, proxyAddress: String? = nil, proxyPort: String? = nil) {
...
func buildAndUploadToAppetize(xcodebuild: [String: Any] = [:], scheme: String? = nil, apiToken: String) {
...
@discardableResult func environmentVariable(set🚀: [String : Any]? = nil, get🚀: String? = nil, remove: String? = nil) -> String {
...
func erb(template: String, destination: String? = nil, placeholders: [String: Any] = [:]) {
...
func githubApi(serverUrl: String = "https://api.github.com", apiToken: String, httpMethod: String = "GET", body: [String: Any] = [:], rawBody: String? = nil, path: String? = nil, url: String? = nil, errorHandlers: [String: Any] = [:], headers: [String: Any] = [:], secure: Bool = true) {
...
func modifyServices(username: String, appIdentifier: String, services: [String: Any] = [:], teamId: String? = nil, teamName: String? = nil) {
...
func scp(username: String, password: String? = nil, host: String, port: String = "22", upload: [String : Any]? = nil, download: [String : Any]? = nil) {
...
func slack(message: String? = nil, channel: String? = nil, useWebhookConfiguredUsernameAndIcon: Bool = false, slackUrl: String, username: String = "fastlane", iconUrl: String = "https://s3-eu-west-1.amazonaws.com/fastlane.tools/fastlane.png", payload: [String: Any] = [:], defaultPayloads: [String]? = nil, attachmentProperties: [String: Any] = [:], success: Bool = true) {
